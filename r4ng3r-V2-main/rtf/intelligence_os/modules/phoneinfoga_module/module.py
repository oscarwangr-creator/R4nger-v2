...
class GeneratedModule(JsonEntityModule):
    name = "phoneinfoga_module"
    category = "generated"
    input_types = ['seed']
    output_types = ['artifact']
    command_template = 'phoneinfoga {seed}'
            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['phoneinfoga'],
                    'pipelines': ['identity_mega_pipeline', 'phone_intelligence_pipeline', 'travel_pattern_pipeline', 'certificate_transparency_pipeline', 'legal_exposure_pipeline', 'api_surface_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
