...
class GeneratedModule(JsonEntityModule):
    name = "github-search_module"
    category = "generated"
    input_types = ['seed']
    output_types = ['artifact']
    command_template = 'github-search {seed}'
            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['github-search'],
                    'pipelines': ['github_secrets_pipeline', 'code_contributor_pipeline', 'recruitment_signal_pipeline', 'press_correlation_pipeline', 'influencer_mapping_pipeline', 'board_member_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
