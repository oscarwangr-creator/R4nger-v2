            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['nmap'],
                    'pipelines': ['domain_infrastructure_pipeline', 'infrastructure_exposure_pipeline', 'credential_reuse_pipeline', 'crypto_wallet_pipeline', 'chat_server_pipeline', 'malware_repo_pipeline', 'dataset_leak_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
