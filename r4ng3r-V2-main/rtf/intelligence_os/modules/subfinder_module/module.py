...
class GeneratedModule(JsonEntityModule):
    ...
    command_template = 'subfinder {seed}'
            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['subfinder'],
                    'pipelines': ['domain_infrastructure_pipeline', 'newsletter_leak_pipeline', 'persona_correlation_pipeline', 'public_records_pipeline', 'asset_ownership_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
