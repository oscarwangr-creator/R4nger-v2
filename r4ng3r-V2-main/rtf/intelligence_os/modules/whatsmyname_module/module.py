...
class GeneratedModule(JsonEntityModule):
    name = "whatsmyname_module"
    category = "generated"
    input_types = ['seed']
    output_types = ['artifact']
    command_template = 'whatsmyname {seed}'
            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['whatsmyname'],
                    'pipelines': ['forum_monitoring_pipeline', 'package_registry_pipeline', 'video_intelligence_pipeline', 'startup_due_diligence_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
