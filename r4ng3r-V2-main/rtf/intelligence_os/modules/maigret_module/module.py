            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['maigret'],
                    'pipelines': ['identity_mega_pipeline', 'username_intelligence_pipeline', 'forum_monitoring_pipeline', 'package_registry_pipeline', 'video_intelligence_pipeline', 'startup_due_diligence_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
