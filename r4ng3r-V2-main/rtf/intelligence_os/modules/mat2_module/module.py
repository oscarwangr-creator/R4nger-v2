            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['mat2'],
                    'pipelines': ['metadata_intelligence_pipeline', 'subsidiary_mapping_pipeline', 'facility_mapping_pipeline', 'academic_research_pipeline', 'ngo_partnership_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
