...
class GeneratedModule(JsonEntityModule):
    name = "metagoofil_module"
    category = "generated"
    input_types = ['seed']
    output_types = ['artifact']
    command_template = 'metagoofil {seed}'
            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['metagoofil'],
                    'pipelines': ['metadata_intelligence_pipeline', 'document_exploitation_pipeline', 'subsidiary_mapping_pipeline', 'facility_mapping_pipeline', 'academic_research_pipeline', 'ngo_partnership_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
