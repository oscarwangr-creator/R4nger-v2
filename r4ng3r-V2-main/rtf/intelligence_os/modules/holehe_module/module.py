            ...
            'artifacts': [
                {
                    ...
                    'toolchain': ['holehe'],
                    'pipelines': ['identity_mega_pipeline', 'email_intelligence_pipeline', 'account_verification_pipeline', 'employee_enumeration_pipeline', 'paste_monitoring_pipeline', 'mobile_app_intelligence_pipeline', 'messaging_app_pipeline', 'conference_exposure_pipeline'],
                    'confidence': 0.7,
                }
            ],
        }
