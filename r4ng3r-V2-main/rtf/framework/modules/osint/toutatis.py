...
class ToutatisModule(ExternalToolModule):
    tool_name = "toutatis"
    tool_description = "Run toutatis from the CLI and parse JSON output."
    tool_category = "osint"
    tool_binary = "toutatis"
    tool_refs = ['https://github.com/megadose/toutatis']
    target_option_name = "username"
    target_option_desc = "Instagram username to inspect"
    default_timeout = 600
