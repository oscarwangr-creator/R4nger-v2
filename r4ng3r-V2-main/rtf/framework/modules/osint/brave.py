...
class BraveSearchModule(ExternalToolModule):
    tool_name = "brave"
    tool_description = "Run brave search engine queries and normalize result entries."
    tool_category = "osint"
    tool_binary = "brave"
    tool_refs = ['https://search.brave.com']
