...
class StartpageSearchModule(ExternalToolModule):
    tool_name = "startpage"
    tool_description = "Run startpage search engine queries and normalize result entries."
    tool_category = "osint"
    tool_binary = "startpage"
    tool_refs = ['https://www.startpage.com']
