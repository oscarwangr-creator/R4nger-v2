...
class GitfiveModule(ExternalToolModule):
    tool_name = "gitfive"
    tool_description = "Run gitfive from the CLI and parse JSON output."
    tool_category = "osint"
    tool_binary = "gitfive"
    tool_refs = ['https://github.com/mxrch/GitFive']
    target_option_name = "username"
    target_option_desc = "GitHub username to inspect"
    default_timeout = 600
