...
class CheckUsernamesModule(ExternalToolModule):
    tool_name = "checkusernames"
    tool_description = "Run checkusernames username discovery from the CLI and normalize discovered accounts."
    tool_category = "osint"
    tool_binary = "checkusernames"
    tool_refs = ['https://github.com/doronbehar/check-usernames']
