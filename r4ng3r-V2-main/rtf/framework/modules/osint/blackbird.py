...
class BlackbirdModule(ExternalToolModule):
    tool_name = "blackbird"
    tool_description = "Run blackbird from the CLI and parse JSON output."
    tool_category = "osint"
    tool_binary = "blackbird"
    tool_refs = ['https://github.com/p1ngul1n0/blackbird']
