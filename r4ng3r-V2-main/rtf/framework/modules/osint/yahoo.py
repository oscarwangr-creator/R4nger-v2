...
class YahooSearchModule(ExternalToolModule):
    tool_name = "yahoo"
    tool_description = "Run yahoo search engine queries and normalize result entries."
    tool_category = "osint"
    tool_binary = "yahoo"
    tool_refs = ['https://search.yahoo.com']
