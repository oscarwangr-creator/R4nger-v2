...
class GoogleSearchModule(ExternalToolModule):
    tool_name = "google"
    tool_description = "Run google search engine queries and normalize result entries."
    tool_category = "osint"
    tool_binary = "google"
    tool_refs = ['https://www.google.com']
