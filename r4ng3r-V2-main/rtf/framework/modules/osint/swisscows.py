...
class SwisscowsSearchModule(ExternalToolModule):
    tool_name = "swisscows"
    tool_description = "Run swisscows search engine queries and normalize result entries."
    tool_category = "osint"
    tool_binary = "swisscows"
    tool_refs = ['https://swisscows.com']
