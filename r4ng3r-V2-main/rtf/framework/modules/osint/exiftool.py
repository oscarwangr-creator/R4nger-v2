...
class ExiftoolModule(ExternalToolModule):
    tool_name = "exiftool"
    tool_description = "Run exiftool from the CLI and parse JSON output."
    tool_category = "osint"
    tool_binary = "exiftool"
    tool_refs = ['https://exiftool.org']
    target_option_name = "target"
    target_option_desc = "File path or URL for metadata extraction"
    default_timeout = 600
