...
class NamechkModule(ExternalToolModule):
    tool_name = "namechk"
    tool_description = "Run namechk username discovery from the CLI and normalize discovered accounts."
    tool_category = "osint"
    tool_binary = "namechk"
    tool_refs = ['https://github.com/haikelfazzani/namechk']
