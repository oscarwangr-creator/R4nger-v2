...
class DuckDuckGoSearchModule(ExternalToolModule):
    tool_name = "duckduckgo"
    tool_description = "Run duckduckgo search engine queries and normalize result entries."
    tool_category = "osint"
    tool_binary = "duckduckgo"
    tool_refs = ['https://duckduckgo.com']
