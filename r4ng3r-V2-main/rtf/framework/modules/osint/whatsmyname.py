...
class WhatsMyNameModule(ExternalToolModule):
    tool_name = "whatsmyname"
    tool_description = "Run whatsmyname username discovery from the CLI and normalize discovered accounts."
    tool_category = "osint"
    tool_binary = "whatsmyname"
    tool_refs = ['https://github.com/WebBreacher/WhatsMyName']
